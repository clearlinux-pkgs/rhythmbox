...
Source0  : https://download.gnome.org/sources/rhythmbox/3.4/rhythmbox-3.4.5.tar.xz
...
Patch1: backport-meson-evil-check.patch
...
%prep
%setup -q -n rhythmbox-3.4.5
cd %{_builddir}/rhythmbox-3.4.5
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1652104588
...
cp %{_builddir}/rhythmbox-3.4.5/COPYING %{buildroot}/usr/share/package-licenses/rhythmbox/3f772bdc589b117aeeb6fbbf5bd277d7c3015a56
